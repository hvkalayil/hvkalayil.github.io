...
</p>`,icons:["Flask","My Sql"]},{link:"https://play.google.com/store/apps/details?id=com.hoseakalayil.musicplayer",name:"Waverix",imgPath:"waverix",description:`
<p>
...
</p>`,icons:["Flutter"]},{link:"https://play.google.com/store/apps/details?id=com.hoseakalayil.whoami",name:"Who Am I",imgPath:"whoami",description:`
<p>
...
</p>`,icons:["Flutter","My Sql","Firebase"]},{link:"https://play.google.com/store/apps/details?id=info.myhealthcard.therapeye",name:"Therapeye",imgPath:"therapeye",description:`
<p>
...
</p>`,icons:["Flutter","Php","My Sql"]},{link:"https://github.com/hvkalayil/aqualy_mob",name:"Aqua.ly",imgPath:"aqualy",description:`
<p>
...
</p>`,icons:["Flutter","Django","My Sql"]},{link:"https://play.google.com/store/apps/details?id=com.hoseavarghese.auto_gallery",name:"Auto Gallery",imgPath:"autoGallery",description:`
<p>
...
<p>
 ...
 in the playstore
</p>`,icons:["Flutter"]},{link:"http://rit.ac.in/",name:" RIT Website",imgPath:"ritwebsite",description:`
<p>
...
`,icons:["Php","Bootstrap","My Sql"]},{link:"https://hvkalayil.github.io/algonaut",name:" Algonaut",imgPath:"algonaut",description:`<p>Algonaut is a web application that serves as a tool for users seeking to deepen their understanding of algorithms while effectively monitoring their learning progress and celebrating their achievements once logged in. The front end of Algonaut was crafted using <strong class="text-hover"> Angular </strong>, ensuring a seamless and intuitive user interface. I orchestrated the deployment on GitHub Pages, employing a streamlined build and deploy process managed through a <strong class="text-hover"> Github Action. </strong>
</p><p>On the backend, I architected robust APIs utilizing <strong class="text-hover"> NestJS </strong>, a modern and scalable framework. It also integrates well with <strong class="text-hover">Swagger</strong> as well, so I have documented the API endpoints in the application The entire backend infrastructure was deployed using <strong class="text-hover"> Render. </strong>
</p><p>Algonaut represents a labor of love, reflecting my genuine dedication to crafting meaningful web applications. It aims to offer a helpful tool for individuals keen on delving into the world of algorithms.</p>`,icons:["Angular","Nest JS"]}],d=[{src:"assets/technologies/html.png",alt:"HTML",title:"HTML",year:2014},{src:"assets/technologies/css.png",alt:"CSS",title:"CSS",year:2014},{src:"assets/technologies/bootstrap.png",alt:"Bootstrap",title:"Bootstrap",year:2014},{src:"assets/technologies/js.png",alt:"JS",title:"Javascript",year:2014},{src:"assets/technologies/ai.png",alt:"Adobe Illustrator",title:"Adobe Illustrator",year:2016},{src:"assets/technologies/ae.png",alt:"Adobe After Effects",title:"Adobe After Effects",year:2016},{src:"assets/technologies/blender.png",alt:"Blender",title:"Blender",year:2018},{src:"assets/technologies/php.png",alt:"Php",title:"Php",year:2018},{src:"assets/technologies/mysql.png",alt:"My Sql",title:"My Sql",year:2018},{src:"assets/technologies/python.png",alt:"Python",title:"Python",year:2020},{src:"assets/technologies/tailwind.png",alt:"Tailwind",title:"Tailwind",year:2020},{src:"assets/technologies/flutter.png",alt:"Flutter",title:"Flutter",year:2020},{src:"assets/technologies/flask.png",alt:"Flask",title:"Flask",year:2020},{src:"assets/technologies/django.png",alt:"Django",title:"Django",year:2020},{src:"assets/technologies/firebase.png",alt:"Firebase",title:"Firebase",year:2020},{src:"assets/technologies/git.png",alt:"Git",title:"Git",year:2020},{src:"assets/technologies/nodejs.png",alt:"Node JS",title:"Node JS",year:2022},{src:"assets/technologies/react.png",alt:"React",title:"React",year:2022},{src:"assets/technologies/mongo.png",alt:"Mongo DB",title:"Mongo DB",year:2022},{src:"assets/technologies/docker.png",alt:"Docker",title:"Docker",year:2022},{src:"assets/technologies/azure.png",alt:"Azure Services",title:"Azure Services",year:2022},{src:"assets/technologies/gcloud.png",alt:"Google Cloud",title:"Google Cloud",year:2022},{src:"assets/technologies/godot.png",alt:"Godot",title:"Godot",year:2022},{src:"assets/technologies/angular.png",alt:"Angular",title:"Angular",year:2022},{src:"assets/technologies/vite.png",alt:"Vite",title:"Vite",year:2022},{src:"assets/technologies/nestjs.png",alt:"Nest JS",title:"Nest JS",year:2023}];function y(){let e="",t="",o="",s=0;const n=f;for(const a of n.reverse())o=v((a==null?void 0:a.link)??""),t=b((a==null?void 0:a.icons)??[]),e+=`
        ...
        </div>`,s+=1;document.getElementById("worksPage").innerHTML=e,document.querySelectorAll(".projectCard").forEach(a=>{a.addEventListener("mouseleave",w)}),document.querySelectorAll(".projectImage").forEach(a=>{a.addEventListener("mouseover",k),a.addEventListener("mouseleave",S)})}function v(e){return e==""?"":`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
    stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
    </svg>`}function b(e){let t="";for(const o of e){const s=d.find(n=>n.title==o);t+=`
            <div class="flex w-8 p-1 items-center overflow-auto hover:scale-110">    
                <img src="${s.src}" alt="${s.alt}" title="${s.title}">
            </div>
        `}return t}function w(e){e.fromElement.scrollTop=0}function k(e){var o;const t=e.srcElement;t.src=((o=t==null?void 0:t.src)==null?void 0:o.replace("png","gif"))??""}function S(e){const t=e.srcElement;t.src=t.src.replace("gif","png")}const x=[{name:"Section 1",image:"1.png",description:"This period laid the foundation for my web development journey,building essential skills in front-end development and introducing me to the power of frameworks like Bootstrap.",points:`<li><strong>Introduction to Web Technologies:</strong> Got inspired by a senior friend's freelancing work and started learning HTML, CSS, and JavaScript basics from W3Schools and CodeAcademy.</li>
        ...
        <li><strong>Game Development with Godot:</strong> Reignited interest in game development, learning Godot through YouTube tutorials.</li>`,year:[2022,2023]}];function A(e){let t="";for(const o of d)o.year>e||(t+=`
        <img class="flex-col w-8 m-1 md:w-12 md:m-2 overflow-auto hover:scale-110" 
        src="${o.src}"
        alt="${o.alt}" title="${o.title}">
        `);document.getElementById("competencyContainer").innerHTML=t}function I(e){for(const t of x)if(t.year.includes(e))return t}function P(e){const t=e.image,o=document.getElementById("myPic");let s=o.src.split("/");s.pop(),s.push(`${t}`),o.src=s.join("/")}function T(e){document.getElementById("journeyDescription").innerHTML=e.description,document.getElementById("journeyPoints").innerHTML=e.points}function E(e){const t=`${e.year[0]}`,o=e.year.length;let s="";o!=1&&(s=`-${e.year[o-1]-2e3}`),document.getElementById("jounreyYearResult").innerHTML=t+s}function g(e){var n;const t=((n=e==null?void 0:e.target)==null?void 0:n.value)??"20230",o=Math.ceil(parseInt(t)/10),s=I(o);A(o),P(s),T(s),E(s)}const D=[{id:"Rajiv1",first:"Rajiv Gandhi Institute Of Technology",second:"Master of Computer Applications (2021)",third:"8.3 CGPA"},{id:"GIAL2",first:"Girideepam Institute Of Advanced Learning",second:"Bachelor of Computer Applications (2019)",third:"7.69 CGPA"},{id:"DB3",first:"Don Bosco HSS",second:"State Board (Kerala)",third:"83%"},{id:"Chavara4",first:"Chavara International High School",second:"ICSE",third:"79%"}],j=[{id:"TCS1",first:"Tata Consultancy Services(TCS)",second:"Developer",third:'<time datetime="2021-10-07">October 7th, 2021</time> - Present',body:`
        ...
        `}];function B(){l("EXP"),l("ACAD")}function l(e){const t=e=="EXP"?j:D,o=e=="EXP"?"workExperience":"academicQualifications";let s="";for(const n of t){let a="";((n==null?void 0:n.link)??!1)&&(a=`
        ...
        `}document.getElementById(o).innerHTML=s,document.querySelectorAll("#expandPanel").forEach(n=>{n.addEventListener("click",L)})}function L(e){const t=document.getElementById(e.currentTarget.dataset.panelname),o=document.getElementById(`${t.id} down`);let s=t.style.display;s=s==""?"none":s,s=="none"?(t.style.display="flex",o.style.transform="rotate(180deg)"):(t.style.display="none",o.style.transform="rotate(0deg)")}function C(){c(),y(),B(),g()}document.querySelectorAll(".themeToggler").forEach(e=>{e.addEventListener("click",m)});document.querySelectorAll(".actionButton").forEach(e=>{e.addEventListener("click",u)});document.getElementById("journey").addEventListener("input",g);document.addEventListener("DOMContentLoaded",C);
