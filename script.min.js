const images=[{src:"assets/technologies/html.png",alt:"HTML",title:"HTML"},{src:"assets/technologies/css.png",alt:"CSS",title:"CSS"},{src:"assets/technologies/sass.png",alt:"SASS",title:"SASS"},{src:"assets/technologies/bootstrap.png",alt:"Bootstrap",title:"Bootstrap"},{src:"assets/technologies/tailwind.png",alt:"Tailwind",title:"Tailwind"},{src:"assets/technologies/js.png",alt:"JS",title:"Javascript"},{src:"assets/technologies/nodejs.png",alt:"Node JS",title:"Node JS"},{src:"assets/technologies/angular.png",alt:"Angular",title:"Angular"},{src:"assets/technologies/flutter.png",alt:"Flutter",title:"Flutter"},{src:"assets/technologies/python.png",alt:"Python",title:"Python"},{src:"assets/technologies/flask.png",alt:"Flask",title:"Flask"},{src:"assets/technologies/django.png",alt:"Django",title:"Django"},{src:"assets/technologies/firebase.png",alt:"Firebase",title:"Firebase"},{src:"assets/technologies/git.png",alt:"Git",title:"Git"},{src:"assets/technologies/php.png",alt:"Php",title:"Php"},{src:"assets/technologies/nextjs.png",alt:"NextJS",title:"Nest JS"},{src:"assets/technologies/vite.png",alt:"Vite",title:"Vite"}];function loadCompetencies(){let b="";for(let a of images)b+=`
        ...
        `}],academics=[{id:"Rajiv1",first:"Rajiv Gandhi Institute Of Technology",second:"Master of Computer Applications (2021)",third:"8.3 CGPA"},{id:"GIAL2",first:"Girideepam Institute Of Advanced Learning",second:"Bachelor of Computer Applications (2019)",third:"7.69 CGPA"},{id:"DB3",first:"Don Bosco HSS",second:"State Board (Kerala)",third:"83%"},{id:"Chavara4",first:"Chavara International High School",second:"ICSE",third:"79%"},];function loadExpAndAcad(){loadData("EXP"),loadData("ACAD")}function loadData(b){let c="";for(let a of"EXP"==b?experience:academics){let d="";a?.link&&(d=`
            <span class="transition-transform transit duration-500 mt-4">
                <a href="assets/cert/${a.link}.pdf" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" />
                    </svg>
                </a>
            </span>`);let e="",f="";a?.body&&(e=`
            <span id="${a.id} down" class="transition-transform transit duration-500 mt-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                </svg>
            </span>
            `,f=`onclick="openDetail(${a.id})"`),c+=`
        <div ${f} class="flex flex-row border-l-4 border-accent-100 border-dotted p-2 pl-4 m-1 transition-colors bg-sidebar dark:bg-sidebar-dark hover:bg-primary-100 hover:dark:bg-primary-dark-100 hover:shadow-sm hover:shadow-accent-100 hover:bg-gradient-to-l hover:from-accent-0">
            <div class="flex-col w-11/12">
                <div class="exp-ball hover:scale-105 transition"> </div>
                <h3 class="text-md md:text-lg font-extrabold"> ${a.first} </h3>
                <h4 class="font-bold"> ${a.second} </h4>
                <h5> ${a.third} </h5>

                <div id="${a.id}" class="flex flex-col w-full pl-4 py-4" style="display:none">
                    ${a.body}
                </div>
            </div>
        ...
        `}document.getElementById("EXP"==b?"workExperience":"academicQualifications").innerHTML=c}function openDetail(a){console.log(a),document.getElementById(`${a.id} up`);let c=document.getElementById(`${a.id} down`),b=a.style.display;"none"==(b=""==b?"none":b)?(a.style.display="flex",c.style.transform="rotate(180deg)"):(a.style.display="none",c.style.transform="rotate(0deg)")}const first={name:"First Lockdown",link:"https://en.wikipedia.org/wiki/COVID-19_lockdown_in_India#Lockdown_in_2020"},flutter={name:"Flutter",link:"https://flutter.dev/"},php={name:"PHP",link:"https://www.php.net/"},python={name:"Python",link:"https://www.python.org/"},flask={name:" Flask",link:"https://flask.palletsprojects.com/en/2.0.x/"},bootstrap={name:"Bootstrap",link:"https://getbootstrap.com/"},firebase={name:"Firebase",link:"https://firebase.google.com/"},fullstack={name:"Full Stack",link:""},djangoREST={name:"Django REST",link:"https://www.django-rest-framework.org/"},worksPage=[{link:"http://crlab.herokuapp.com/",name:"CR Lab",imgPath:"crlab",description:`
        <p>
        ...
        `,icons:[bootstrap,php,fullstack]}];function loadWorks(){let c="",d="",e="",b=0;for(let a of worksPage.reverse())e=setNewTabSvg(a.link),d=setIcons(a.icons),c+=`
        <div class="card-container">
            <div id="scrollable${b}" class="card" onmouseleave="triggerScrollReset('scrollable${b}')">
            <!-- Heading -->
            <div class="heading">
        ...
        </div>`,b+=1;document.getElementById("worksPage").innerHTML=c}function setNewTabSvg(a){return""==a?"":`<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
    stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
    </svg>`}function setIcons(c){let a="";for(let b of c)a+=`
        <a
        href="${b.link}"
        target="_blank"
            ...
            ${b.name}
        </a>`;return a}function triggerScrollReset(a){document.getElementById(a).scrollTop=0}function setTheme(){findExperience();let a=document.querySelectorAll("#darkIcon"),b=document.querySelectorAll("#lightIcon");a.forEach(a=>a.style.display="none"),b.forEach(a=>a.style.display="none"),"dark"!==localStorage.theme&&("theme"in localStorage||window.matchMedia("(prefers-color-scheme: dark)").matches)?(document.querySelector(":root").style.setProperty("--hvk-scrollbar","#f7fdff"),b.forEach(a=>a.style.display="block"),document.documentElement.classList.remove("dark")):(document.querySelector(":root").style.setProperty("--hvk-scrollbar","#222527"),a.forEach(a=>a.style.display="block"),document.documentElement.classList.add("dark")),setupActiveButton()}function findExperience(){let b=new Date("10/07/2021"),c=new Date,a=(c.getFullYear()-b.getFullYear())*12;a-=b.getMonth();let d=`${a+=c.getMonth()} months`;if(a>11){let e=Math.floor(a/12);a-=12*e,d=`${e}.${a=Math.floor(100*a/120)} years`}document.getElementById("exp").innerHTML="Experience: "+d}function toggleTheme(){let a=localStorage.theme;localStorage.theme="dark"==a?"light":"dark",setTheme()}function setupActiveButton(){let a=document.getElementById("firstBtn");a.classList.add("bg-accent-100"),a.classList.add("border-accent-900")}let currentPage="worksPage";function changePage(a){let b=document.getElementById("firstBtn");b.classList.remove("bg-accent-100"),b.classList.remove("border-accent-900");let d=document.getElementById(currentPage),c=document.getElementById(a);d.style.display="none",c.style.display="flex",c.classList.add("transit"),setTimeout(()=>{c.style.opacity=1},800),currentPage=a}function showGif(a){a.src=a.src.replace("png","gif")}function hideGif(a){a.src=a.src.replace("gif","png")}